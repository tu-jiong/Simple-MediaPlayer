...
public class HlsCacheableDataSourceFactory implements DataSource.Factory {
    ...
    public DataSource createDataSource() {
        return new HlsCacheableDataSource(context, config.isCache(), config.getCachePath(), listener, config.getApplicationId(), DefaultHttpDataSource.DEFAULT_CONNECT_TIMEOUT_MILLIS,
